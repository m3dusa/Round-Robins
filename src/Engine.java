...
public class Engine {
	...
	/**
	 * Analyze the images using an algorithm chosen below.
	 *  Each algorithm is a method (ex: deltaComparison, edgeDetection)
	 *  Use this area to test new algorithms.
	 * @param if1
	 * @param if2
	 */
	public void analyze(ImageFrame if1, ImageFrame if2) {
		...
		switch(ALGORITHM) {
			case 0: deltaComparison(if1, if2);
					break;
			case 1: edgeDetection(if1);
					break;
		}
...
//						+ " " + d2Array[2] + " " + d2Array[3]);
	...
	/**
	 * ----- ALGORITHM 2 -----
	 * Detects edges in an image by comparing neighboring pixels
	 *  and marking at positions that differ above some threshold value
